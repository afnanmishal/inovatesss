...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('dashboard_assets')); ?>/vendor/chartist/css/chartist.min.css">
    <link href="<?php echo e(asset('dashboard_assets')); ?>/vendor/bootstrap-select/dist/css/bootstrap-select.min.css"
        rel="stylesheet">
    <link href="<?php echo e(asset('dashboard_assets')); ?>/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="<?php echo e(asset('dashboard_assets')); ?>/images/logo.png" alt="">
                <img class="logo-compact" src="<?php echo e(asset('dashboard_assets')); ?>/images/logo-text.png" alt="">
                <img class="brand-title" src="<?php echo e(asset('dashboard_assets')); ?>/images/logo-text.png" alt="">
            </a>
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('dashboard_assets')); ?>/images/avatar/1.jpg"
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('dashboard_assets')); ?>/images/avatar/2.jpg"
                                                    class="rounded-circle user_img" alt="" />
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('dashboard_assets')); ?>/images/avatar/3.jpg"
                                                    class="rounded-circle user_img" alt="" />
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('dashboard_assets')); ?>/images/avatar/4.jpg"
                                                    class="rounded-circle user_img" alt="" />
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="<?php echo e(asset('dashboard_assets')); ?>/images/avatar/5.jpg"
                                                    class="rounded-circle user_img" alt="" />
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                                ...
                                                <div class="timeline-panel">
                                                    <div class="media mr-2">
                                                        <img alt="image" width="50"
                                                            src="<?php echo e(asset('dashboard_assets')); ?>/images/avatar/1.jpg">
                                                    </div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    <div class="header-info">
                                        <span class="text-black"><strong><?php echo e(Auth::user()->name); ?></strong></span>
                                        <div class="profile-role px-3 pt-2">
                                            <h6>
                                                <?php echo e(Auth::user()->role); ?>

                                            </h6>
                                        </div>
                                        <p class="fs-12 mb-0"><?php echo e(Auth::user()->email); ?></p>
                                    </div>
                                </a>

                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?php echo e(url('profile')); ?>" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="./page-register.html">Add category</a></li>
                        <li><a href="<?php echo e(route('category.index')); ?>">View Category</a></li>
    ...
    ***********************************-->
    ...
    <script src="<?php echo e(asset('dashboard_assets')); ?>/vendor/chart.js/Chart.bundle.min.js"></script>
    ...
    <script src="<?php echo e(asset('dashboard_assets')); ?>/vendor/owl-carousel/owl.carousel.js"></script>

    <!-- Chart piety plugin files -->
    <script src="<?php echo e(asset('dashboard_assets')); ?>/vendor/peity/jquery.peity.min.js"></script>

    <!-- Apex Chart -->
    <script src="<?php echo e(asset('dashboard_assets')); ?>/vendor/apexchart/apexchart.js"></script>

    <!-- Dashboard 1 -->
    <script src="<?php echo e(asset('dashboard_assets')); ?>/js/dashboard/dashboard-1.js"></script>
    <script>
...
<?php /**PATH F:\watch\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>