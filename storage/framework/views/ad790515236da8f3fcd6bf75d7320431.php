				...
				<div class="row align-items-center">
					<div class="col col-md-6 order-last">
						<div class="about_image">
							<img src="<?php echo e(asset('frontend_assets')); ?>/images/about/about_image.jpg" alt="image_not_found">
						</div>
					</div>
			...
			<div class="container">
				...
				<div class="row justify-content-center">
					<div class="col col-lg-3 col-md-4 col-sm-6">
						<div class="team_item">
							<div class="team_image">
								<img src="<?php echo e(asset('frontend_assets')); ?>/images/team/team_1.jpg" alt="image_not_found">
							</div>
					...
					<div class="col col-lg-3 col-md-4 col-sm-6">
						<div class="team_item">
							<div class="team_image">
								<img src="<?php echo e(asset('frontend_assets')); ?>/images/team/team_2.jpg" alt="image_not_found">
							</div>
							<div class="team_content">
					...
					<div class="col col-lg-3 col-md-4 col-sm-6">
						<div class="team_item">
							<div class="team_image">
								<img src="<?php echo e(asset('frontend_assets')); ?>/images/team/team_3.jpg" alt="image_not_found">
							</div>
							<div class="team_content">
								<h3 class="team_member_name">Harry Dor</h3>
								<span class="team_member_title">CEO/Founder</span>
					...
					<div class="col col-lg-3 col-md-4 col-sm-6">
						<div class="team_item">
							<div class="team_image">
								<img src="<?php echo e(asset('frontend_assets')); ?>/images/team/team_4.jpg" alt="image_not_found">
							</div>
							<div class="team_content">
								<h3 class="team_member_name">John Swim</h3>
								<span class="team_member_title">Fashion Designer</span>
...
<?php echo $__env->make('layouts.frontendMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\watch\resources\views/frontend/about.blade.php ENDPATH**/ ?>