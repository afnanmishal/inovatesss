        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <ul class="nav register_tabnav ul_li_center" role="tablist">
                    ...
                    <li role="presentation">
                        <button data-bs-toggle="tab" class="active" data-bs-target="#signup_tab" type="button" role="tab" aria-controls="signup_tab" aria-selected="true">Register</button>
                    </li>
                </ul>

                <div class="register_wrap tab-content" id="signin">
                    <div class="tab-pane fade show " id="signin_tab" role="tabpanel">
                    ...
                    <div class="tab-pane fade show active" id="signup_tab" role="tabpanel">
                        <form action="<?php echo e(route('customerreg')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php if(session('customerreg')): ?>
                            <div class="alert alert-success">
                                <?php echo e(session('customerreg')); ?>
                            ...
                            <div class="form_item_wrap">
                                ...
                                <div class="form_item">
                                    <label for="password_input2"><i class="fas fa-lock"></i></label>
                                    <input id="password_input2" type="password" name="confirm_password" placeholder="Confirm your Password">
                                </div>
                            </div>
                            <div class="form_item_wrap">
                                ...
                                <div class="form_item">
                                    ...
                                    <input id="password_input2" type="tel" name="number" placeholder="your phone number">
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.frontendMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\watch\resources\views/frontend/account.blade.php ENDPATH**/ ?>