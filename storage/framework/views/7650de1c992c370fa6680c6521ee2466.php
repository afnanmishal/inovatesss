...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('frontend_assets')); ?>/images/logo/favourite_icon_1.png">

    <!-- fraimwork - css include -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/bootstrap.min.css">

    <!-- icon font - css include -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/fontawesome.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/stroke-gap-icons.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/icofont.css">

    <!-- animation - css include -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/animate.css">

    <!-- carousel - css include -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/slick.css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/slick-theme.css">

    <!-- popup - css include -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/magnific-popup.css">

    <!-- jquery-ui - css include -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/jquery-ui.css">

    <!-- select option - css include -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/nice-select.css">

    <!-- woocommercen - css include -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/woocommerce.css">

    <!-- custom - css include -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend_assets')); ?>/css/style.css">
</head>
...
<body>
                            ...
                            <ul class="header_select_options ul_li">
                                <li>
                                    <div class="select_option">
                                        <div class="flug_wrap">
                                            <img src="<?php echo e(asset('frontend_assets')); ?>/images/flug/flug_uk.png"
                                                alt="image_not_found">
                                        </div>
                                        <select>
                        ...
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            <div class="brand_logo">
                                <a class="brand_link" href="index.html">
                                    <img src="<?php echo e(asset('frontend_assets')); ?>/images/logo/logo_1x.png"
                                        srcset="<?php echo e(asset('frontend_assets')); ?>/images/logo/logo_2x.png 2x" alt>
                                </a>
                            </div>
                        </div>
                            ...
                            <nav class="main_menu navbar navbar-expand-lg">
                                <div class="main_menu_inner collapse navbar-collapse" id="main_menu_dropdown">
                                    ...
                                    <ul class="main_menu_list ul_li">
                                        <li><a class="nav-link" href="<?php echo e(route('index')); ?>">Home</a></li>
                                        <li><a class="nav-link" href="<?php echo e(route('about')); ?>">About us</a></li>
                        ...
                        <div class="col col-md-3">
                            <ul class="header_icons_group ul_li_right">
                                ...
                                <?php if(auth()->guard()->guest()): ?>
                                    <li>
                                        <a href="<?php echo e(route('account')); ?>">Login/Registration</a>
                                    </li>
                                <?php endif; ?>
                                <?php if(auth()->guard()->check()): ?>
                                    <li>
                                        <a href="#"><?php echo e(auth::user()->name); ?></a>
                                        <a href="#"><?php echo e(auth::user()->role); ?></a>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_about">
                                <div class="brand_logo">
                                    <a class="brand_link" href="index.html">
                                        <img src="<?php echo e(asset('frontend_assets')); ?>/images/logo/logo_1x.png"
                                            srcset="<?php echo e(asset('frontend_assets')); ?>/images/logo/logo_2x.png 2x"
                                            alt="logo_not_found">
                                    </a>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-6">
                            <div class="footer_widget footer_contact">
                                ...
                                <ul class="store_btns_group ul_li">
                                    <li><a href="#!"><img
                                                src="<?php echo e(asset('frontend_assets')); ?>/images/app_store.png"
                                                alt="app_store"></a></li>
                                    <li><a href="#!"><img
                                                src="<?php echo e(asset('frontend_assets')); ?>/images/play_store.png"
                                                alt="play_store"></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <div class="payment_method">
                                <h4>Payment:</h4>
                                <img src="<?php echo e(asset('frontend_assets')); ?>/images/payments_icon.png"
                                    alt="image_not_found">
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?php echo e(asset('frontend_assets')); ?>/js/jquery-plugins-collection.js"></script>

    <!-- google map  -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>
    <script src="<?php echo e(asset('frontend_assets')); ?>/js/gmaps.min.js"></script>

    <!-- custom - main-js -->
    <script src="<?php echo e(asset('frontend_assets')); ?>/js/main.js"></script>

</body>

</html>
<?php /**PATH F:\watch\resources\views/layouts/frontendMaster.blade.php ENDPATH**/ ?>